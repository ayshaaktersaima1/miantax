import TaxServicesContent from '@/components/contents/TaxServicesContent';
    ...
    return (
        <div>
            <PageBanner title="Tax services"
                backgroundImage="/images/TaxServices.webp"></PageBanner>
            ...
            <section className="bg-[#F8F7F4] py-16 md:py-20">
                <div className="mx-auto grid w-11/12 gap-10 lg:grid-cols-[minmax(0,1fr)_380px] lg:items-start">
                    <TaxServicesContent></TaxServicesContent>
                    <ServiceSidebar />
                </div>
            </section>
        </div>
